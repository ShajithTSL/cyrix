	...
	<header class="navbar navbar-expand" role="navigation">
		<div class="container">
			...
			<div class="collapse navbar-collapse justify-content-end">
				...
				<button 
					class="company-btn {% if !frappe.defaults.get_default('company') %}company-alert{% endif %}" 
...
<style>
	.company-btn {
		background: linear-gradient(135deg, #00adef 0%, #015ca3 100%);
		color: #fff !important;
		padding: 6px 16px;
		border-radius: 20px;
		border: none;
	...
	/* ALERT WHEN COMPANY NOT SET */
	.company-alert {
		background: linear-gradient(135deg, #ff4d4f 0%, #c1121f 100%);
		animation: sirenAlert 1.2s infinite ease-in-out;
	}
	...
	@keyframes sirenAlert {
		...
		0% {
			background: linear-gradient(135deg, #ff4d4f 0%, #c1121f 100%);
			box-shadow:
				0 0 0px rgba(255, 77, 79, 0.4);
			transform: scale(1);
		}

		50% {
			background: linear-gradient(135deg, #c1121f 0%, #ff4d4f 100%);
			box-shadow:
				0 0 10px rgba(255, 77, 79, 0.9),
...
//# sourceMappingURL=cyrix.bundle.F5355IOP.js.map
