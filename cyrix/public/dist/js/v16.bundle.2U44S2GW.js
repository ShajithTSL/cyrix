(() => {
  ...
  // ../cyrix/cyrix/public/v16.bundle.js
...
`);
  (function() {
    ...
    function getDefault(key) {
      try {
        var value = "";
        if (frappe.defaults && typeof frappe.defaults.get_default === "function") {
    ...
    function getInitials(value) {
      ...
      return value.trim().split(/[\s\-\u00b7]+/).filter(Boolean).slice(0, 2).map(function(word) {
        return word.charAt(0);
      }).join("").toUpperCase();
    }
    function openDefaults() {
      try {
        if (frappe.ui && frappe.ui.toolbar && typeof frappe.ui.toolbar.setup_session_defaults === "function") {
    ...
    function markCollapse() {
      ...
      var collapsed = sidebar.classList.contains("collapsed") || sidebar.offsetWidth > 0 && sidebar.offsetWidth < 100;
    ...
    if (typeof frappe !== "undefined" && typeof frappe.after_ajax === "function") {
    ...
    try {
      if (frappe.router && typeof frappe.router.on === "function") {
        frappe.router.on("change", function() {
          setTimeout(function() {
            if (!document.getElementById("mtv16-company-btn") || !document.getElementById("mtv16-sidebar-org")) {
              build();
            } else {
              refreshValues();
              markCollapse();
...
//# sourceMappingURL=v16.bundle.2U44S2GW.js.map
